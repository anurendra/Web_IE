...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_iters', type=int, default=2000, help='Number of iterations for training')
    parser.add_argument('--test_iters', type=int, default=50, help='Number of iterations for testing')
    ...
    #Test check training
    train_data = os.path.join(os.environ["HOME"],'TextMaps/data_shops/page_sets/train_list.txt')

    test_data = os.path.join(os.environ["HOME"],'TextMaps/data_shops/page_sets/test_list.txt')
	...
	print('Loss:',train_net.blobs['loss'].data)
        ...
        if iteration%test_every_n_iters==0:
            ...
            print 'NET: image accuracy:', name_acc
            print 'NET: price accuracy:', price_acc
            print 'NET: name accuracy:', im_acc
    ...
    train_net_results, _ = test.test_net(test_model, snapshot_path, train_data, final_test_iters, position_maps)
    ...
    train_im_acc, train_price_acc, train_name_acc = train_net_results
    print 'train data: image acc:', train_im_acc
    print 'train data: price acc:', train_price_acc
    print 'train data: name acc"' , train_name_acc
